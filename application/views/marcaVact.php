							...
							<div class="card">
								...
								<div class="card-body wizard-content">
									...
									<?php foreach ($marca as $m) {  ?>									
										<form action="<?php echo base_url().'marcaC/actualizar'?> "method="POST" onsubmit="return validarFormulario()">
											<div>
												<h3>Marca</h3>
												<section>
													<input type="hidden" name="id_marca" required="" value="<?php echo $m->id_marca ?>">
													<label for="userName">Ingresar Marca</label>
													<input type="text" name="nombre_marca" id="marca" value="<?php echo $m->nombre_marca ?>">
												</div>
