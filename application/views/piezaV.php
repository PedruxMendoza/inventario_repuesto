...
<?php $this->load->helper('ajax_pieza') ?>
<body>
	<!-- ============================================================== -->
				...
				<div class="page-breadcrumb">
					<div class="row">
						<div class="col-12 d-flex no-block align-items-center">
							<h4 class="page-title">Pieza</h4>
							<div class="ml-auto text-right">
								<button type="button" class="btn btn-success" id="nuePie">Nuevo</button>  
					...
					<div class="modal fade" id="pieza">
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<!-- Modal body -->
								<div class="modal-body">
									<form id="formPieza" action="" method="POST" style="font-family: 'Montserrat', cursive; color: #46281e;">
										<input type="hidden" name="Id_pieza" id="id" value="0">
										<!-- 		====================== -->
										<div class="row my-3">

											<div class="col" id="oculto">
												<div class="input-group">
													<span class="input-group-text"><i class="fa fa-tags">&nbsp</i>Nombre Pieza</span>
													<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="nombre_pieza" id="nombre_pieza" >
												</div>
											</div>
