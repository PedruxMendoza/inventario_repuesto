	<?php $this->load->helper('ajax_categoria') ?>
	<body>
		<!-- ============================================================== -->
						...
						<div class="row">
							<div class="col-12 d-flex no-block align-items-center">
								...
								<div class="ml-auto text-right">
									<button type="button" class="btn btn-success" id="nueCat">Nuevo</button>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="modal fade" id="categoria">
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<!-- Modal body -->
								<div class="modal-body">
									<form id="formCategoria" action="" method="POST" style="font-family: 'Montserrat', cursive; color: #46281e;">
										<input type="hidden" name="id_categoria" id="id" value="0">
										<div class="row">
											<!-- 		====================== -->
											<div class="row my-3">
												<div class="col" id="oculto">
													<div class="input-group">
														<span class="input-group-text"><i class="fa fa-tags">&nbsp</i>Nombre Categoria</span>
														<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="nombre_categoria" id="nombre_categoria" >
													</div>
												</div>
											</div>
										</div>
