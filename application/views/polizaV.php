				...
				<div class="page-breadcrumb">
					<div class="row">
						<div class="col-12 d-flex no-block align-items-center">
							<h4 class="page-title">Poliza</h4>
							<div class="ml-auto text-right">
								<button type="button" class="btn btn-info" id="nuePolx">Nueva poliza</button>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="modal fade" id="poliza">
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<!-- Modal body -->
								<div class="modal-body">
									<form id="formPoliza" action="" method="POST" style="font-family: 'Montserrat', cursive; color: #46281e;">
										<input type="hidden" name="id_poliza" id="id" value="0">
										<div class="row">
											<!-- 		====================== -->
											<div class="row my-3">

												<div class="col" id="oculto">
													<div class="input-group">
														<span class="input-group-text"><i class="fa fa-tags">&nbsp</i>Codigo Poliza</span>
														<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="id_poliza" id="id_poliza2" >
													</div>
												</div>
												...
												<div class="col">
													<div class="input-group">
														...
														<select name="tipo_contenedor" id="nombre_contenedor" class="form-control">
											...
											<div class="col">
												<div class="input-group">
													<span class="input-group-text"><i class="fa fa-tags">&nbsp</i>Cantidad</span>
													<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="cantidad" id="cantidad">
												</div>
											</div>

											<div class="col">
												<div class="input-group">
													<span class="input-group-text"><i class="fa fa-tags">&nbsp</i>Peso</span>
													<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="peso" id="peso">
												</div>
											</div>

											<div class="col">
												<div class="input-group">
													<span class="input-group-text"><i class="fa fa-tags">&nbsp</i>Doc Transporte</span>
													<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="doc_transporte" id="doc_transporte">
												</div>
											</div>
										</div>
