<script src="<?php echo base_url('props/js/transmision.js'); ?>"></script>
<?php $this->load->helper('ajax_transmision') ?>
<body>
	<!-- ============================================================== -->
		...
		<header class="topbar" data-navbarbg="skin5">
			...
			<div class="page-wrapper">
				...
				<div class="page-breadcrumb">
					<div class="row">
						<div class="col-12 d-flex no-block align-items-center">
							<h4 class="page-title">Transmision</h4>
							<div class="ml-auto text-right">
								<button type="button" class="btn btn-success" id="nueTr">Nuevo</button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Transmision</h4>
				...
				<body>
					...
					<div class="modal fade" id="transmision">
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<!-- Modal body -->
								<div class="modal-body">
									<form id="formTransmision" action="" method="POST" style="font-family: 'Montserrat', cursive; color: #46281e;">
										<input type="hidden" name="id_transmision" id="id" value="0">
										<div class="row">
											<!-- 		====================== -->
											<div class="row my-3">
												...
												<div class="col">
													<div class="input-group">
														<span class="input-group-text"><i class="fa fa-tags">&nbsp</i>Transmision</span>
														<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="tipo_transmision" id="tipo_transmision">
													</div>
												</div>
